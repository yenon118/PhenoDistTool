...
<script src="{{ asset('system/home/PhenoDistTool/js/viewVariantAndPhenotypeFigures.js') }}" type="text/javascript">
</script>
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                if (res && phenotype) {
                    ...
                    plotFigure(genotypeAndImprovementStatusData, 'Genotype', 'Improvement_Status_Summary',
            ...
            error: function(xhr, status, error) {
                ...
                var p_tag = document.createElement('p');
                p_tag.innerHTML =
                    "Improvement status summary figure is not available due to lack of data!!!";
