async function queryPhenotypeDistribution(organism, dataset, chromosome, phenotypes) {
...
async function updatePhenotypeDistribution(phenotype_accordion_id, organism, dataset, chromosome, phenotypes) {
    var result_array = await queryPhenotypeDistribution(organism, dataset, chromosome, phenotypes);
